...
public class PriorityQueue
{
    ...
    /// If multiple items share the same highest priority, the one that was added first (FIFO) is returned.
    ...
    public string Dequeue()
    {
        ...
        // Find the index of the highest-priority item (FIFO if tie)
